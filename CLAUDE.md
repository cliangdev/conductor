...
- [`docs/tiktok-app-review.md`](docs/tiktok-app-review.md) — TikTok app-review resubmission pack: portal field values, the multi-tenant use-case wording, the `video.list` justification, demo script, and the `conductor.rexipe.io` cutover checklist.
