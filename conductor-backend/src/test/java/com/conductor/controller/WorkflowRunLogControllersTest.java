...
class WorkflowRunLogControllersTest {
    ...
    /** {@link WorkflowInternalCallbackController}'s dispatch endpoint collaborator. */
    @MockitoBean
    private com.conductor.workflow.WorkflowExecutionEngine workflowExecutionEngine;
