...
/**
 * DB-backed coverage for the generic per-item scheduling columns (V111): {@code scheduled_for} and
...
class WorkItemSchedulingTest extends AbstractNoneWebIntegrationTest {
    ...
    // [auto] V111 applies cleanly and adds both columns plus the partial index
    @Test
