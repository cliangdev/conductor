...
/**
 * Health tracking for a connection, end to end against a real Postgres so the V128 columns, the
...
class ConnectionHealthServiceTest extends AbstractNoneWebIntegrationTest {
    ...
    // ---- [auto] V128 applies and the three health columns round-trip on the Connection entity ----
