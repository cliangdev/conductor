...
public class ReviewService {
     ...
     * hashes to. A review predating V129 carries a null round and a null hash and skips both, exactly as it
     * does at the gate.
     *
    ...
    private static boolean stillStands(Review review, int currentRound, String currentBundleHash) {
        ...
        // No hash. Legacy (pre-V129, null round) is honoured; a modern review with no hash was given
