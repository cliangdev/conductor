...
public class NotificationSignalMapper {
    ...
    private static String toSignalType(EventType eventType) {
        return switch (eventType) {
            ...
            case POST_AWAITING_MANUAL -> SignalTypes.CONDUCTOR_WORK_ITEM_AWAITING_MANUAL_PUBLISH;
            case AUTO_TRANSITION_BLOCKED -> SignalTypes.CONDUCTOR_WORK_ITEM_AUTO_TRANSITION_BLOCKED;
